      ...
      <section class="c-sort-box">
        <section class="c-s-dl">
          <dl>
            ...
            <dd class="c-s-dl-li">
              <ul class="clearfix">
                <li>
                  <a title="全部" href="#" @click="initCourse(1, 8, searchObj2)"
                    >全部</a
                  >
                </li>
                <li
                  v-for="(items, index) in subjectNestedList"
                  :key="index"
                ...
                >
                  <a
                    :title="items.title"
                    href="#"
                    @click="searchOne(items.id, index)"
                    >{{ items.title }}</a
                  >
                </li>
              </ul>
          ...
          <dl>
            ...
            <dd class="c-s-dl-li">
              <ul class="clearfix">
                <li
                  v-for="(items, index) in subSubjectList"
                  :key="index"
                ...
                >
                  <a
                    :title="items.title"
                    href="#"
                    @click="searchTwo(items.id, index)"
                    >{{ items.title }}</a
                  >
                </li>
              </ul>
        ...
        <div class="mt40">
          ...
          <article v-if="data.total > 0" class="comm-course-list">
            <ul class="of" id="bna">
              <li v-for="items in data.items" :key="items.id">
                <div class="cc-l-wrap">
...
export default {
  ...
  methods: {
    ...
    //9，点击“全部”的方法
    initCourse() {
      courseApi.getCourseList(1, 8, this.searchObj2).then((response) => {
        this.data = response.data.data;
        this.oneIndex = -1;
        this.twoIndex = -1;
      });
